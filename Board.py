...
class Board:
    ...
    def addSnakesAndLadders(self, cells : List[List[Cell]], numberOfSnakes : int, numberofLadders : int) -> None:
        ...
        while numberOfSnakes > 0:
            self.snakeHead = random.randrange(1, (self.n * self.n ),1)  # between 1 - 100
            self.snakeTail = random.randrange(1, (self.n * self.n ),1)  # between 1 - 100
        ...
        while numberofLadders > 0:
            self.ladderStart = random.randrange(1, (self.n * self.n ),1)  # between 1 - 100
            self.ladderEnd = random.randrange(1, (self.n * self.n ),1)  # between 1 - 100
